...
export type SimplifiedHTMLProperties<T> = React.DetailedHTMLProps<React.HTMLAttributes<T>, T> & { variant?: string };
...
const ButtonImage:
    React.FC<SimplifiedHTMLProperties<HTMLImageElement>> =
  className,
  ...props
