...
const NotificationComponent = (properties: { notification: Notification, destroy: Function }): ReactElement => {
    const {notification, destroy} = properties;
    ...
    return (
        <CSSTransition timeout={500} classNames="notification" {...{...properties, destroy: undefined}} >
    >
