...
const GlobalTheme = createGlobalStyle`
  body {
    color: ${(properties): string => properties.theme.foreground.page};
    background: ${(properties): string => properties.theme.background.page};
  }
`;

const ThemeProvider = (properties: PropsWithChildren<{}>): ReactElement => {
