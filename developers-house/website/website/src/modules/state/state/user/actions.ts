...
export function loginUser (): ThunkAction<void, RootState, PayloadTypes | NotificationPayloadType, Action<(PayloadTypes | NotificationPayloadType)['type']>> {
...
export function logoutUser (): ThunkAction<void, RootState, PayloadTypes | NotificationPayloadType, Action<(PayloadTypes | NotificationPayloadType)['type']>> {
    return async (dispatch): Promise<void> => {
        dispatch({
            type: 'USER_LOGOUT'
        });
